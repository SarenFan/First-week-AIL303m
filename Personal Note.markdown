...
![Quy trình Machine Learning](images/ml_workflow.png)  
...
### 2.3 NoSQL & MongoDB
![Cấu trúc dữ liệu JSON](images/json_structure.png)  
...
![So sánh hiệu suất](images/pandas_dask_spark.png)  
...
![Heatmap giá trị null](images/missing_values_heatmap.png)  
...
![p-value](images/p_value_distribution.png)  
...
![Model Bias](images/model_bias.png)  
