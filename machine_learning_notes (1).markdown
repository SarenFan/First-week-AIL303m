...
- **Raw URL (khuyến nghị)**: Lấy URL raw từ GitHub:
  1. Mở ảnh trên GitHub (ví dụ: `https://github.com/SarenFan/First-week-AIL303m/blob/main/images/ml_workflow.png`).
  2. Click nút **Raw** để lấy URL: `https://raw.githubusercontent.com/SarenFan/First-week-AIL303m/main/images/ml_workflow.png`.
  3. Dùng trong Markdown:
     ```markdown
     ![Tên hình](https://raw.githubusercontent.com/SarenFan/First-week-AIL303m/main/images/filename.png)
     ```
...
- **Kiểm tra branch**: Nếu repo dùng `master` thay vì `main`, sửa URL thành:
  ```markdown
  ![Tên hình](https://raw.githubusercontent.com/SarenFan/First-week-AIL303m/master/images/filename.png)
  ```
